...
=======
  portfolio: state.portfolioListing.portfolioList.find((portfolio) => {
>>>>>>> Renamed some parameters. Fixed bug where portfolio name instead of uid was passed to store
